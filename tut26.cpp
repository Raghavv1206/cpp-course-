...
// below line means that non member-sumcomplex function is allowed to do anything  with my privates parts(members)
...
6. it cannot access teh member directly by their names and need object_name.member_name 
